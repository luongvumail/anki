...
describe('StreakCalculator', () => {
  ...
  it('increments streak when studying on consecutive days', () => {
    const day1State: StreakState = { currentStreak: 1, longestStreak: 1, lastStudyDate: '2026-08-05' };
  ...
  it('resets streak to 1 if day missed', () => {
    const day1State: StreakState = { currentStreak: 5, longestStreak: 5, lastStudyDate: '2026-08-03' };
    const today = new Date('2026-08-06T10:00:00Z');
