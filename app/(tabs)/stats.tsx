              ...
              <View style={styles.trophyRow}>
                <View
                  style={[
                    ...
                    { backgroundColor: "rgba(255, 200, 0, 0.15)", marginRight: 10 },
                  ]}
                >
            ...
            <View style={styles.guideListContainer}>
              ...
              <DuolingoCard style={styles.guideCard}>
                <View style={styles.guideHeaderRow}>
                  <View
                    style={[styles.guideIconTile, { backgroundColor: "rgba(168, 85, 247, 0.15)" }]}
                  >
              ...
              <DuolingoCard style={styles.guideCard}>
                <View style={styles.guideHeaderRow}>
                  <View
                    style={[styles.guideIconTile, { backgroundColor: "rgba(28, 176, 246, 0.15)" }]}
                  >
                ...
                <View style={styles.gestureGuideList}>
                  <View style={styles.gestureRowItem}>
                    <Text style={styles.gestureText}>
                      ...
                      Lật thẻ Flashcard xem Hán tự, Pinyin, Phát âm, Dịch nghĩa & Bộ thủ.
                    </Text>
                  </View>
                  <View style={styles.gestureRowItem}>
                    <Text style={styles.gestureText}>
                      ...
                      Làm bài Quiz kiểm tra kiến thức đa dạng dạng bài.
                    </Text>
                  </View>
                  <View style={styles.gestureRowItem}>
                    <Text style={styles.gestureText}>
                      ...
                      Tự động lập vòng lặp sửa lỗi nhanh cho các câu làm sai hoặc làm chậm (&gt;4
                      giây).
                    </Text>
                  </View>
                </View>
              ...
              <DuolingoCard style={styles.guideCard}>
                <View style={styles.guideHeaderRow}>
                  <View
                    style={[styles.guideIconTile, { backgroundColor: "rgba(88, 204, 2, 0.15)" }]}
                  >
                ...
                <View style={styles.gestureGuideList}>
                  <View style={styles.gestureRowItem}>
                    <Text style={styles.gestureText}>
                      ...
                      Nhớ ý nghĩa cơ bản của từ vựng mới.
                    </Text>
                  </View>
                  <View style={styles.gestureRowItem}>
                    <Text style={styles.gestureText}>
                      ...
                      Chuẩn hóa phiên âm &amp; dấu thanh điệu.
                    </Text>
                  </View>
                  <View style={styles.gestureRowItem}>
                    <Text style={styles.gestureText}>
                      <Text style={{ fontWeight: "800", color: Colors.duolingo.purple }}>
                        Nghe âm thanh chọn Hán tự:
                      </Text>{" "}
                      Rèn phản xạ thính giác.
                    </Text>
                  </View>
                  <View style={styles.gestureRowItem}>
                    <Text style={styles.gestureText}>
                      <Text style={{ fontWeight: "800", color: Colors.duolingo.green }}>
                        Điền câu Cloze ngữ cảnh:
                      </Text>{" "}
                      Ứng dụng từ vựng trong câu hoàn chỉnh.
                    </Text>
                  </View>
                </View>
              </DuolingoCard>
              ...
              <DuolingoCard style={styles.guideCard}>
                <View style={styles.guideHeaderRow}>
                  <View
                    style={[styles.guideIconTile, { backgroundColor: "rgba(255, 200, 0, 0.15)" }]}
                  >
                ...
                <View style={styles.gestureGuideList}>
                  <View style={styles.gestureRowItem}>
                    <Text style={styles.gestureText}>
                      ...
                      Thử thách ghép cặp Hán tự ↔ Nghĩa siêu tốc.
                    </Text>
                  </View>
                  <View style={styles.gestureRowItem}>
                    <Text style={styles.gestureText}>
                      ...
                      Ghép câu ví dụ có kèm từ gây nhiễu rèn ngữ pháp.
                    </Text>
                  </View>
                  <View style={styles.gestureRowItem}>
                    <Text style={styles.gestureText}>
                      <Text style={{ fontWeight: "800", color: Colors.duolingo.purple }}>
                        Phòng Luyện Phát Âm AI:
                      </Text>{" "}
                      Thu âm đọc Hán tự, AI chấm điểm Pinyin &amp; 4 thanh điệu.
                    </Text>
                  </View>
                </View>
              </DuolingoCard>
              ...
              <DuolingoCard style={styles.guideCard}>
                ...
                <Text style={styles.guideDesc}>
                  Nhập từ Hán hoặc câu văn Tiếng Trung ➔ AI tự động trích xuất Pinyin, Nghĩa Tiếng
                  Việt, Phân tích Bộ thủ siêu ngắn gọn và tạo Câu ví dụ chuẩn ngữ cảnh trong 1 giây.
                </Text>
              </DuolingoCard>
              ...
              <DuolingoCard style={styles.guideCard}>
                <View style={styles.guideHeaderRow}>
                  <View
                    style={[styles.guideIconTile, { backgroundColor: "rgba(255, 150, 0, 0.15)" }]}
                  >
                ...
                <Text style={styles.guideDesc}>
                  Tích lũy XP qua bài học để thăng hạng qua 6 cấp danh hiệu Hán ngữ chuẩn (từ{" "}
                  ...
                  ) và chinh phục Bộ 14 Huy hiệu thành tích cá nhân.
                </Text>
              </DuolingoCard>
            </View>
          </Animated.View>
